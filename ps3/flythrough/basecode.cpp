...
int main(void)
{
    int terminate=0;             // State variable
    CameraObject camera;         // Initialize

    camera.z=10.0;               // Initialize
    camera.y=5.0;                // Initialize
    ...
    while(0==terminate)
    {
        ...
        int wid,hei;               // State variable
        FsGetWindowSize(wid,hei);  // Initialize
